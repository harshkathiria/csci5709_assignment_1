                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr class="align-middle">
                                ...
                                <td>09 Jul, 2023</td>
                                <td>15:30</td>
                                <td><button class="flex w-full items-center justify-center rounded-md border border-transparent bg-gray-500 py-1 w-24 text-sm font-medium text-white">
                ...
                class="flex w-full items-center justify-center rounded-md border border-transparent bg-red-500 py-1 w-24 text-sm font-medium text-white hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                  Cancel
                            ...
                            <tr class="align-middle">
                                ...
                                <td>21 Sep, 2023</td>
                                <td>11:00</td>
                                <td><button class="flex w-full items-center justify-center rounded-md border border-transparent bg-green-600 py-1 w-24 text-sm font-medium text-white">
